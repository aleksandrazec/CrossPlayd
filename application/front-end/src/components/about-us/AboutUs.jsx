        ...
        <div className="parent">
            <div className="child">
                ...
                <div className="trending-games">
                    <h3>Our mission</h3>
                    <hr></hr>
                    <p style={{ textJustify: "true" }}>The purpose of the application CrossPlayd is to allow users to track and review video games they've played all in one place. Rather than being a replacement for other video game scoring sites, this application focuses on creating a user-based community for every game of interest, no matter if the user owns it and independently of the platform they've played it on. This also allows for logging of older or discontinued games, as well as games that are not available on major platforms.</p>
                    <h3>Creators</h3>
                    <hr></hr>
                    <table className='links'>
                        <tbody>
                            <tr>
                                <td><a href="https://github.com/aleksandrazec">Aleksandra Zec</a></td>
                                <td><a href="https://github.com/Matej3334">Matej Kunovski</a></td>
                                <td><a href="https://github.com/CDNSeverov">Nikola Severov</a></td>
                                <td><a href="https://github.com/AndrejKaz">Andrej Kaziovski</a></td>
                            </tr>
                        </tbody>
                    </table>
